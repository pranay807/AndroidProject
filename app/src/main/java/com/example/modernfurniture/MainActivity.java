...
public class MainActivity extends AppCompatActivity {
    ...
    private ArFragment arFragment; //required for permission to use camera
    ...
    AnchorNode anchorNode; //search plane to detect the position
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Calculates the position when you tap on the screen then it detects the surface
